...
function scrapeYelp(ind, locat, start){
  var values=[];
  var jsonvalues=[];
  var today = new Date();
  var url='https://www.yelp.com/search?find_desc='+ind+'&find_loc='+locat+'&start='+start;
      ...
      res.send({
        ...
        "Failure":"Internal Server Error"
          ...
          if(result.length==0){            
            ...
            scrapeYelp(industry,location,start)
            }else{
...
exports.searchylp = function(req,res){
  var page=req.query.page;
  console.log('page requested', page);
  var start=(page-1)*10;
  var searchId;
